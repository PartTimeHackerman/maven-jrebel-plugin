...
import org.zeroturnaround.javarebel.maven.model.*;
...
public class GenerateRebelMojo extends AbstractMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        final File rebelRemoteXmlFile = new File(rebelXmlDirectory, "rebel-remote.xml").getAbsoluteFile();
     ...
     */
    private RebelXmlBuilder buildWar(RebelXmlBuilder builder) throws MojoExecutionException {
     ...
     * @throws MojoExecutionException
     */
    private RebelXmlBuilder buildJar(RebelXmlBuilder builder) throws MojoExecutionException {
        buildClasspath(builder);
